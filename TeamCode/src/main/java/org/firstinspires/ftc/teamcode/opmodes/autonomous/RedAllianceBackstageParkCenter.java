...
@Autonomous(name="Red Alliance Backstage Park Center", group="Autonomous Red")
public class RedAllianceBackstageParkCenter extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryGenerator trajectoryGenerator = new RedBackstageTrajectoryGenerator(element);

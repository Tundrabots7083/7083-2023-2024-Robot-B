...
/**
 * Blue Alliance backstage trajectories. These are a "mirror" representation of the Red Alliance
 * trajectories. As such, changes should be made to the red alliance trajectories.
 */
@Config
public class BlueBackstage extends BlueAutonomous {
    public static double DELAY_OPMODE = RedBackstage.DELAY_OPMODE; // Delay in seconds; defaults to zero

    // Starting Pose
    public static double START_POSE_X = RedBackstage.START_POSE_X;
    ...
    public static double SPLINE_ANGLE = -RedBackstage.SPLINE_ANGLE;
    public static double SPLINE_CONSTANT_HEADING_ANGLE = -RedBackstage.SPLINE_CONSTANT_HEADING_ANGLE;

    // Spike mark locations
    public static double OUTER_SPIKE_MARK_X = RedBackstage.OUTER_SPIKE_MARK_X;
    public static double OUTER_SPIKE_MARK_Y = -RedBackstage.OUTER_SPIKE_MARK_Y;
    public static double MIDDLE_SPIKE_MARK_X = RedBackstage.MIDDLE_SPIKE_MARK_X;
    public static double MIDDLE_SPIKE_MARK_Y = -RedBackstage.MIDDLE_SPIKE_MARK_Y;
    public static double INNER_SPIKE_MARK_X = RedBackstage.INNER_SPIKE_MARK_X;
    public static double INNER_SPIKE_MARK_Y = -RedBackstage.INNER_SPIKE_MARK_Y;
    public static double INNER_SPIKE_MARK_HEADING = -RedBackstage.INNER_SPIKE_MARK_HEADING;

    public static double REVERSE_POSITION_X = RedBackstage.REVERSE_POSITION_X;
    public static double REVERSE_POSITION_Y =-RedBackstage.REVERSE_POSITION_Y;
    ...
    public BlueBackstage(AutoMecanumDrive mecanumDrive) {
        ...
        innerSpikeMarkParkCenter = new SequentialAction(
                ...
                robot.lift.setLiftTo(Lift.Position.SCORE_MEDIUM),
                innerMoveToScore,
                robot.rightPixelCollector.depositPixel(),
                innerMoveToLowerLift,
                robot.lift.setLiftTo(Lift.Position.INTAKE),
                innerParkCenter
        );

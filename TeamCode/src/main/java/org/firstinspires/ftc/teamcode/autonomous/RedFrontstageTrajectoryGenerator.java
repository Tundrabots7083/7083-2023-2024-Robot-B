...
public class RedFrontstageTrajectoryGenerator implements TrajectoryGenerator {
    ...
    public static final Vector2d INNER_SPIKE_MARK_INTERMEDIATE_POSITION = new Vector2d(-41.5, -32);
    ...
    public static final Vector2d BACKDROP_MIDDLE_POSITION = new Vector2d(42, -39);
